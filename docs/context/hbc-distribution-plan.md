...
| Package | `com.daverui.michelly` (`MiChelly`), version `1.3.0`, `type: "web"`, `rootRequired: false` |
| IPK | `https://daver-ui.github.io/webos-hub/ipk/com.daverui.michelly_1.3.0_all.ipk` (sha256 `ceedaed1249e8a064f68f401fc84bc44208640d2a569a270b9d41211d4000f87`) |
...
| --- | --- |
| `id` | `com.daverui.michelly` |
| `version` | must equal `version` in `frontend/appinfo.json` (currently `1.3.0`) |
...
`build/com.daverui.michelly_1.3.0_all.ipk` (architecture-independent).
  ...
  "packages": [
    {
      ...
      "manifest": {
        ...
        "title": "MiChelly",
        "iconUri": "https://daver-ui.github.io/webos-hub/icons/michelly.png",
        "ipkUrl": "https://daver-ui.github.io/webos-hub/ipk/com.daverui.michelly_1.3.0_all.ipk",
...
sha256sum build/com.daverui.michelly_1.3.0_all.ipk
...
`1.3.0` while the manifest advertises a different string, HBC believes the installed version differs
