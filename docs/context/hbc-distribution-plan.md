...
| Package | `com.daverui.michelly` (`MiChelly`), version `1.3.1`, `type: "web"`, `rootRequired: false` |
| IPK | `https://daver-ui.github.io/webos-hub/ipk/com.daverui.michelly_1.3.1_all.ipk` (sha256 `f96b774129b918fad04e0e6f2706837e19252ff9e5a1d08d2a4e42c75ad726a5`) |
...
| --- | --- |
| `id` | `com.daverui.michelly` |
| `version` | must equal `version` in `frontend/appinfo.json` (currently `1.3.1`) |
...
`build/com.daverui.michelly_1.3.1_all.ipk` (architecture-independent).
  ...
  "packages": [
    {
      ...
      "manifest": {
        ...
        "title": "MiChelly",
        "iconUri": "https://daver-ui.github.io/webos-hub/icons/michelly.png",
        "ipkUrl": "https://daver-ui.github.io/webos-hub/ipk/com.daverui.michelly_1.3.1_all.ipk",
...
sha256sum build/com.daverui.michelly_1.3.1_all.ipk
...
`1.3.1` while the manifest advertises a different string, HBC believes the installed version differs
